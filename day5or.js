const intcode = (program, inputs) => {
    ...
    let stop = false;
    for(let i=0; i<s.length && !stop;) {
        const instructions = s.slice(i, i+4);
        ...
        switch(opcode) {
            case 1:
                s[instructions[3]] = getParameter(1) + getParameter(2);
            ...
            case 2:
                ...
                break;
            case 3:
                s[instructions[1]] = inputs.shift();
                // console.log('opcode 3', instructions[1], s[instructions[1]]);
                i+=2;
                break;
            case 4:
                console.log(getParameter(1));
            ...
            case 99:
                ...
                break;
            default:
                console.log('FAILURE WRONG OPCODE AT POSITION', i, ':', instructions[0]);
                stop = true;
                break;
        }
